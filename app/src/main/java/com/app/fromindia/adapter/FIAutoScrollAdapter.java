...
public class FIAutoScrollAdapter extends LoopingPagerAdapter<MenuItem> {

    private static final int VIEW_TYPE_NORMAL = 100;
    private static final int VIEW_TYPE_SPECIAL = 101;

    public FIAutoScrollAdapter(Context context, ArrayList<MenuItem> itemList, boolean isInfinite) {
    ...
    protected View inflateView(int viewType, ViewGroup container, int listPosition) {
        ...
        return LayoutInflater.from(context).inflate(R.layout.inflate_autoscroll_item, container, false);
    }
