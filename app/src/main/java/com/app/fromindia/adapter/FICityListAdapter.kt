...
class FICityListAdapter internal constructor(val aStaticMenuList: ArrayList<MenuItem>, aContext: FragmentActivity?) : RecyclerView.Adapter<FICityListAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FICityListAdapter.ViewHolder {
        val v = LayoutInflater.from(parent.context).inflate(R.layout.inflate_city_item, parent, false)
        return ViewHolder(v)
    }

    //this method is binding the data on the list
    override fun onBindViewHolder(holder: FICityListAdapter.ViewHolder, position: Int) {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(aStaticMenuItem: MenuItem, mFragmentManager: FIFragmentManager?, aContext: FragmentActivity?) {
            val aCityIM = itemView.findViewById(R.id.cityLogoIM) as CircleImageView
            val aCityNameTxt = itemView.findViewById(R.id.cityNameTXT) as TextView
