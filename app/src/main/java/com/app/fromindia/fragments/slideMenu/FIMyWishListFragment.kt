...
import com.app.fromindia.adapter.FIMyWishListAdapter
...
class FIMyWishListFragment : Fragment() {

    private var mWishListRC: RecyclerView? = null

    private var TAG = "FIMyWishListFragment"
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val aView: View = inflater.inflate(R.layout.fragment_my_wish_list, container,
                false)
    ...
    private fun classWidgets(aView: View) {
        mWishListRC = aView!!.findViewById(R.id.mywishListRC) as RecyclerView
    ...
    private fun toSetStaticValue(aView: View) {
        ...
        val adapter = FIMyWishListAdapter(aStaticMenu, activity)

        mWishListRC!!.layoutManager = LinearLayoutManager(activity, RecyclerView.VERTICAL, false)

        mWishListRC!!.adapter = adapter
    }
