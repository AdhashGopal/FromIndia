...
import kotlinx.android.synthetic.main.fragment_my_notification.*
import kotlinx.android.synthetic.main.fragment_my_notification.view.*

class FIMyNotificationFragment : Fragment() {
    private var TAG = "FIMyNotificationFragment"

    private var mNRC: RecyclerView? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val aView: View = inflater.inflate(R.layout.fragment_my_notification, container,
                false)
    ...
    private fun classWidgets(aView: View) {
        ...
        mNRC = aView!!.findViewById(R.id.notificationRC) as RecyclerView
    ...
    private fun toSetStaticValue(aView: View) {
        ...
        val adapter = FINotificationAdapter(aStaticMenu, activity)

        mNRC!!.layoutManager = LinearLayoutManager(activity, RecyclerView.VERTICAL, false)

        mNRC!!.adapter = adapter
    }
